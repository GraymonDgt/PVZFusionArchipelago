...
from .Locations import PVZFLocation, location_table, common_fusion_table, snow_common_fusion_table, metal_fusion_table, gold_fusion_table, advanced_fusion_table, peashooter_fusion_table# ,GFZ_table,THZ_table,DSZ_table,CEZ_table,ACZ_table,
...
def create_regions(world: MultiWorld, options: PVZFOptions, player: int):
    ...
    if options.adventure_extra == 2:
        ...
        "Snowy Night: Level 1 (1)","Snowy Night: Level 1 (2)"
                    )
...
#
    ...
    if options.adventure_odyssey or options.goal_type == 2:
            create_locs(regOM,
            "Odyssey Adventure: Gatling Doom (1)",
            "Odyssey Adventure: Gatling Icicle-shroom (1)",
            "Odyssey Adventure: Big Bang Cherry (1)",
            "Odyssey Adventure: Twin Solar-nut (1)",
            "Odyssey Adventure: Aristocattail (1)",
            "Odyssey Adventure: Empress-shroom (1)",
            "Odyssey Adventure: Cornveyor Weed (1)",
            "Odyssey Adventure: Phoenix Threepeater (1)",
            "Odyssey Adventure: Obsidian Spikerock (1)",
            "Odyssey Adventure: Omni Pumpkin (1)",
            "Odyssey Adventure: Pharos Umbrella (1)",
            "Odyssey Adventure: Buck-shroom Squad (1)",
            "Odyssey Adventure: Calamity-shroom (1)",
            "Odyssey Adventure: Tesla Magnet (1)",
            "Odyssey Adventure: Radiant Pot (1)",
            "Odyssey Adventure: Midas Umbrella (1)",
            "Odyssey Adventure: Tycoonwood (1)",
            "Odyssey Adventure: Grim Arbiter (1)",
            "Odyssey Adventure: Dragonbreath Torcher (1)",

            "Odyssey Adventure: Gatling Doom (2)",
            "Odyssey Adventure: Gatling Icicle-shroom (2)",
            "Odyssey Adventure: Big Bang Cherry (2)",
            "Odyssey Adventure: Twin Solar-nut (2)",
            "Odyssey Adventure: Aristocattail (2)",
            "Odyssey Adventure: Empress-shroom (2)",
            "Odyssey Adventure: Cornveyor Weed (2)",
            "Odyssey Adventure: Phoenix Threepeater (2)",
            "Odyssey Adventure: Obsidian Spikerock (2)",
            "Odyssey Adventure: Omni Pumpkin (2)",
            "Odyssey Adventure: Pharos Umbrella (2)",
            "Odyssey Adventure: Buck-shroom Squad (2)",
            "Odyssey Adventure: Calamity-shroom (2)",
            "Odyssey Adventure: Tesla Magnet (2)",
            "Odyssey Adventure: Radiant Pot (2)",
            "Odyssey Adventure: Midas Umbrella (2)",
            "Odyssey Adventure: Tycoonwood (2)",
            "Odyssey Adventure: Grim Arbiter (2)",
            "Odyssey Adventure: Dragonbreath Torcher (2)",
                        )
    ...
    if options.odyssey_minigames!=0:
        ...
        if options.odyssey_minigames>1:
            create_locs(regOddMini,
                        ...
                        "Stats VS Mechanics 1 (1)",
                        "Odyssey Gacha: Gacha Box (1)",
                        ...
                        "Stats VS Mechanics 1 (2)",
                        "Odyssey Gacha: Gacha Box (2)",
                        )


    if options.fusionsanity["Common"]>0:
        for key in common_fusion_table:
            create_locs(regMM,key)
    ...
    if options.fusionsanity["Common+"] > 0:
        for key in peashooter_fusion_table:
            create_locs(regMM,key)


    if options.fusionsanity["Advanced"] > 0:
        for key in advanced_fusion_table:
            create_locs(regMM,key)
