...
class CompletionType(Choice):
    ...
    Odyssey Adventure - Odyssey Adventure: Dragonbreath Torcher
...
class MinigameSanity(Choice):
    """Short: Adds 29 shorter 2-flag Minigames as items/locations
    All: Adds all 61 normal mini-games as items/locations"""
    option_off = 0
    option_short = 1
    option_all = 2
    default = 0
...
class OdysseyMinigames(Choice):
    """Short - Adds the 14 Odyssey mini-games that are less than 10-flags as items/locations
...
class Fusionsanity(OptionCounter):
    """Adds creating each unique fusion as a check
    (Toggle these individually)
    Common - All basic common fusions
    Common+ - Common fusions that require more than 2 plants / metal objects.
    Advanced - Advanced Fusions"""
    default = {
        "Common": 0,
        "Common+":0,
        "Advanced": 0
